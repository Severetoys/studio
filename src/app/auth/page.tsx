...
const GPayIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="48" height="20" viewBox="0 0 51.998 20.768">
      <g transform="translate(-256.346 -393.662)">
        <path d="M42.348,22.212v3.468H50.5c-.432,4.2-3.6,8.46-8.148,8.46a9.444,9.444,0,0,1,0-18.888,8.8,8.8,0,0,1,5.964,2.256l2.7-2.7a14.7,14.7,0,0,0-8.664-3.2A15.1,15.1,0,0,0,27.25,31.5a15.1,15.1,0,0,0,15.1-15.1,13.632,13.632,0,0,0-.324-3.468H42.348Z" transform="translate(244.244 382.023)" fill="#fff"/>
        <path d="M72.012,30.768a4.522,4.522,0,0,1-4.608-4.608V17.028h2.364V26.16a2.231,2.231,0,0,0,2.244,2.244,2.231,2.231,0,0,0,2.244-2.244V17.028h2.364V26.16A4.522,4.522,0,0,1,72.012,30.768Z" transform="translate(204.654 376.634)" fill="#fff"/>
        ...
        <path d="M106.3,22.272l-3.072,11.2H100.7l3.12-11.2h2.556Z" transform="translate(170.81 373.862)" fill="#fff"/>
      </g>
    </svg>
);
