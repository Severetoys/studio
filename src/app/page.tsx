            ...
            <main className="relative z-10 flex flex-col items-center justify-center flex-1 w-full max-w-4xl mx-auto pt-8">
                ...
                <div className="w-full max-w-xs flex flex-col items-center gap-y-6">
                    ...
                    <div className="flex justify-center items-center w-full">
                        ...
                        <div className="flex-1 transition-transform hover:scale-105">
                           <Image src="https://firebasestorage.googleapis.com/v0/b/authkit-y9vjx.firebasestorage.app/o/WhatsApp%20Image%202025-07-26%20at%2002.02.58%20(1).jpeg?alt=media&token=00683b6b-59ac-483c-93f4-6c879ab9b86c" alt="Google Pay" width={338} height={135} className="object-contain" style={{ transform: 'scale(0.7)' }}/>
                        </div>
                    </div>
