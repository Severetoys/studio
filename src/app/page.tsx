    ...
    <div className="p-4 md:p-8 bg-background flex flex-col items-center gap-6">
      <div className="w-full max-w-sm flex flex-col items-center gap-6 text-center">
        ...
        <div className="text-left w-full space-y-4 text-muted-foreground">
            ...
            <h3 className="font-semibold text-primary/90 text-lg text-center">Características Físicas</h3>
            ...
            <h3 className="font-semibold text-primary/90 text-lg mt-6 text-center">Durante as sessões</h3>
