        ...
        <nav className="p-4 overflow-y-auto h-[calc(100%-65px)]">
          <ul className="space-y-2">
             <Accordion type="single" collapsible className="w-full">
              ...
              <li><Link href="/videos/venda-avulsa" className="block p-3 rounded-md hover:bg-muted" onClick={onClose}>VÍDEOS</Link></li>
              <li><Link href="/videos/assinatura" className="block p-3 rounded-md hover:bg-muted" onClick={onClose}>ASSINATURA</Link></li>
